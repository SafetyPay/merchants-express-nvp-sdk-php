<?php
  ...
  *
  *    Syntax:
  *        string SHA256::safetypay_sha256( string message[, string format ])
  *
  *    Description:
  *        SHA256::safetypay_sha256() is a static function that must be called with `message`
  ...
  *
  *    Usage:
  *        $hash = SHA256::safetypay_sha256('string to hash');
  *
  ******************************************************************************/
  ...
  // static class. Access via SHA256::safetypay_sha256()
  class SHA256 extends hash
  {
      function safetypay_sha256($str, $mode = 'hex')
      {
          ...
          else
          {
              ...
              {
                  trigger_error('SHA256::safetypay_sha256' . $mode . '() NOT IMPLEMENTED.', E_USER_WARNING);
              }
          }
